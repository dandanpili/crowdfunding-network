 ...
 * Generated at: 2021-04-17 08:12:23 UTC
...
public final class role_002dpage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/modal-role-comfirm.jsp", Long.valueOf(1605877474901L));
    ...
    _jspx_dependants.put("/WEB-INF/modal-role-add.jsp", Long.valueOf(1605860138379L));
    _jspx_dependants.put("/WEB-INF/modal-role-edit.jsp", Long.valueOf(1605861312905L));
    _jspx_dependants.put("/WEB-INF/modal-role-assign-auth.jsp", Long.valueOf(1606381902738L));
  }
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\tlayer.msg(\"操作失败！\" + response.status + \" \" + response.statusText);\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t//关闭模态框\r\n");
      ...
      out.write("\t\t//使用jQuery对象的on()函数可以解决上面的问题\r\n");
      out.write("\t\t//①首先找到所有“动态生成”的元素所附着的“静态”元素\r\n");
      out.write("\t\t//②on()函数的第一个参数是事件类型\r\n");
      out.write("\t\t//③on()函数的第二个参数是找到真正要绑定事件的元素选择器\r\n");
      out.write("\t\t//④on()函数的第三个参数是时间的响应函数\r\n");
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t\t//获取当前角色的id\r\n");
      out.write("\t\t\t//为了让执行更新的按钮能够获取到roleId的值，把它放到全局变量上\r\n");
      ...
      out.write("\t\t\tconsole.log(requestBody);\r\n");
      out.write("\t\t\t$.ajax({\r\n");
      ...
      out.write("\t\t\t$(\"#summaryBox\").prop(\"checked\", false);\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//9.给单条删除按钮绑定单击响应函数\r\n");
      out.write("\t\t$(\"#rolePageBody\").on(\"click\", \".removeBtn\", function(){\r\n");
      out.write("\t\t\t//从当前角色出发获取角色名称\r\n");
      out.write("\t\t\tvar roleName = $(this).parent().prev().text();\r\n");
      out.write("\t\t\t//创建一个role对象存入数组\r\n");
      ...
      out.write("\t\t\t//创建一个数组对象用来存放后面获取到的角色对戏那个\r\n");
      out.write("\t\t\tvar roleArray = [];\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t<button type=\"button\" id=\"batchRemoveBtn\" class=\"btn btn-danger\"\r\n");
      out.write("\t\t\t\t\t\t\tstyle=\"float: right; margin-left: 10px;\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\" glyphicon glyphicon-remove\"></i> 删除\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<button type=\"button\" id=\"showAddModalBtn\" class=\"btn btn-primary\"\r\n");
      ...
      out.write("\t\t\t\t</div> \r\n");
      out.write("\t\t\t\t<div class=\"modal-footer\">\r\n");
      out.write("\t\t\t\t\t<button id=\"assignBtn\" type=\"button\" class=\"btn btn-primary\">保存</button>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
