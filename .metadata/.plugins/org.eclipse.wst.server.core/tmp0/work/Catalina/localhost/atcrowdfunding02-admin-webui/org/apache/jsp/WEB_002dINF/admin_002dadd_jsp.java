 ...
 * Generated at: 2021-04-17 15:24:29 UTC
...
return;
    ...
    try {
      ...
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"exampleInputPassword1\">登录账号</label> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"loginAcct\" type=\"text\" class=\"form-control\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tid=\"exampleInputPassword1\" placeholder=\"请输入登录账号\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"exampleInputPassword1\">登录密码</label> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"userPswd\" type=\"text\" class=\"form-control\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tid=\"exampleInputPassword1\" placeholder=\"请输入登录密码\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"exampleInputPassword1\">用户昵称</label> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"userName\" type=\"text\" class=\"form-control\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tid=\"exampleInputPassword1\" placeholder=\"请输入用户昵称\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"exampleInputEmail1\">邮箱地址</label> <input \r\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"email\" type=\"email\"\r\n");
